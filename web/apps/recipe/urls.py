...
urlpatterns = [
    ...
    urls.path("recipetemplates/", r_views.RecipeTemplateListView.as_view(), name="recipe_template_list"),
    urls.path("recipe/<uuid:pk>", r_views.RecipeDetailView.as_view(), name="recipe_detail"),
    urls.path("recipe/<uuid:pk>/clone", r_views.RecipeCloneView.as_view(), name="recipe_clone"),
    ...
    urls.path("recipe/<uuid:pk>/delete", r_views.RecipeDeleteView.as_view(), name="recipe_delete"),
