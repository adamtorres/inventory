...
urlpatterns = [
    urls.path(
        "api/order/<uuid:pk>/modify_date/<slug:action>", m_views.APIOrderModifyDateView.as_view(),
        name="api_order_modify_date"),
    ...
    urls.path(
        "order/<uuid:pk>/printable_invoice", m_views.OrderPrintableInvoiceView.as_view(),
