...
class ItemInStockSerializer(serializers.ModelSerializer):
    ...
    common_item_name_group_id = serializers.SerializerMethodField()
    ...
    def get_common_item_name_group_id(self, obj):
        return obj.raw_incoming_item.rawitem_obj.common_item_name_group.id
