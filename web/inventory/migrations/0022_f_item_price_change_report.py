...
BEGIN
    ...
    , short_data AS (
        SELECT DISTINCT
            ...
            tall_data."commonitem_name", FORMAT('''%s', tall_data."item_code") AS "ticked_item_code", tall_data."name",
    ...
    SELECT
        ...
        short_data."commonitem_name", short_data."ticked_item_code", short_data."name",
